...
def show_image():
    """
    Function to open a file dialog and display the selected image on the GUI.
    """
    global filename
...
def hide():
    """
    Function to hide a secret message within the selected image.
    """
    global secret
...
def save():
    """
    Function to save the image with the hidden secret message to a specified file.
    """
...
def show():
    """
    Function to reveal the hidden secret message from the selected image.
    """
...
def reset_all():
    """
    Function to reset all the fields and image on the GUI.
    """
    txt1.delete("1.0", END)
    txt2.delete("1.0", END)
    l1.config(image='')
